...
\begin{exercises}
    ...
    \begin{center}
        \begin{tikzpicture}[line join=round,line cap=round]
            ...
            % Tấm bìa A: ba hình quạt bằng nhau.
            \path[fill=cyan!45!black,draw=black!65]
                (OA) -- ++(-30:1.35) arc[start angle=-30,end angle=90,radius=1.35] -- cycle;
            \path[fill=red!75!orange,draw=black!65]
                (OA) -- ++(90:1.35) arc[start angle=90,end angle=210,radius=1.35] -- cycle;
            \path[fill=orange!85,draw=black!65]
                (OA) -- ++(210:1.35) arc[start angle=210,end angle=330,radius=1.35] -- cycle;
            \node[text=white,font=\bfseries] at ($(OA)+(30:0.76)$) {2};
            \node[text=white,font=\bfseries] at ($(OA)+(150:0.76)$) {1};
            \node[text=white,font=\bfseries] at ($(OA)+(270:0.76)$) {3};
            \draw[white,line width=1.5pt,-{Stealth[length=2.5mm,width=2mm]}]
                (OA) -- ($(OA)+(270:0.84)$);
            \node[below=5pt of OA,yshift=-1.35cm] {Tấm bìa A};

            % Tấm bìa B: năm hình quạt bằng nhau.
            \path[fill=red!75!orange,draw=black!65]
        ...
        \begin{center}
            \begin{tblr}{
                ...
                \begin{tikzpicture}[baseline=(current bounding box.center)]
                    \path[use as bounding box] (0,0) rectangle (3.1,0.95);
                    \draw (0,0.95) -- (3.1,0);
                    \node[anchor=north east,font=\small] at (3.0,0.9) {Tấm bìa A};
                    \node[anchor=south west,font=\small] at (0.1,0.05) {Tấm bìa B};
                \end{tikzpicture}
                & 1 & 2 & 3 \\
                1 & $(1, 1)$ & $(1, 2)$ & $(1, 3)$ \\
                2 & $(2, 1)$ & $(2, 2)$ & $(2, 3)$ \\
