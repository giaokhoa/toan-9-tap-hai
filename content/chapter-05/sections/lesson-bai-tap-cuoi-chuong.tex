...
\begin{exercises}
    ...
    \begin{questions}[resume=SGK]
        ...
        \begin{tasks}(4)
            \task[(A)] $\dfrac{10\pi}{3}$ cm$^2$.
            \task[(B)] $\dfrac{50\pi}{3}$ cm$^2$.
            \task[(C)] $20\pi$ cm$^2$.
            \task[(D)] $10\pi$ cm$^2$.
        \end{tasks}
        \par\noindent\answerbox\par
...
\begin{practice}
    ...
    \begin{enumerate}
        ...
        \begin{tasks}(4)
            \task[(A)] $S_{\mathrm{xq}}=2\pi Rh$.
            \task[(B)] $S_{\mathrm{xq}}=\pi Rh$.
            \task[(C)] $S_{\mathrm{xq}}=\pi Rl$.
            \task[(D)] $S_{\mathrm{xq}}=\pi R^2h$.
        \end{tasks}
        \par\noindent\answerbox\par
        ...
        \begin{tasks}(4)
            \task[(A)] $l^2=h^2+R^2$.
            \task[(B)] $\dfrac{1}{l^2}=\dfrac{1}{h^2}+\dfrac{1}{R^2}$.
            \task[(C)] $R^2=h^2+l^2$.
            \task[(D)] $l^2=hR$.
        \end{tasks}
        \par\noindent\answerbox\par
        ...
        \begin{tasks}(4)
            \task[(A)] $V=4\pi a^3$.
            \task[(B)] $V=\dfrac{4}{3}\pi a^3$.
            \task[(C)] $V=\dfrac{2}{3}\pi a^3$.
            \task[(D)] $V=\dfrac{5}{3}\pi a^3$.
        \end{tasks}
        \par\noindent\answerbox\par
