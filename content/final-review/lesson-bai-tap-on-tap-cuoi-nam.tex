...
\begin{exercises}
    ...
    \begin{questions}[resume=SGK]
        ...
        \begin{center}
            \begin{tikzpicture}[scale=0.95]
                ...
                \pic[draw,"$\alpha$",angle radius=7mm,angle eccentricity=1.35] {angle=A--K--H};
                \pic[draw,"$\beta$",angle radius=4.5mm,angle eccentricity=1.55] {angle=B--K--H};
            \end{tikzpicture}
        \end{center}
    ...
    \begin{questions}[resume=SGK]
        ...
        \begin{center}
            \begin{tblr}{colspec={*{10}{Q[c,m,1.08cm]}}}
        ...
        \begin{questions}
            ...
            \begin{center}
                \begin{tblr}{colspec={Q[l,m,4.4cm] *{3}{Q[c,m,2cm]}}}
...
\begin{practice}
    ...
    \begin{questions}[resume=SBT]
        ...
        \begin{center}
            \begin{tikzpicture}[scale=1.05]
                ...
                \pic[draw,"$54^\circ$",angle radius=6mm,angle eccentricity=1.5] {angle=B--C--A};
                \pic[draw,"$74^\circ$",angle radius=8mm,angle eccentricity=1.35] {angle=A--C--D};
    ...
    \begin{questions}[resume=SBT]
        ...
        \begin{center}
            \begin{tblr}{colspec={Q[c,m,3.2cm] *{4}{Q[c,m,1.35cm]}}}
                Tổ & 1 & 2 & 3 & 4 \\
        ...
        \begin{center}
            \begin{tblr}{colspec={Q[c,m,3cm] *{4}{Q[c,m,2.05cm]}}}
