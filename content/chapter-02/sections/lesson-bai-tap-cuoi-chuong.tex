...
\begin{exercises}
    ...
    \begin{questions}[resume=SGK]
        ...
        \begin{tikzpicture}[x=1.25cm,y=0.075cm]
            ...
            \node at (2.5,42.5) {40\%};
            \node at (3.5,32.5) {30\%};
            \node[rotate=90] at (-0.7,23) {Tỉ lệ};
            \node at (2,-5.6) {Chiều cao (cm)};
            \node[font=\bfseries] at (2,51.5) {Tỉ lệ chiều cao các cây keo giống trồng trong nhà kính};
            \node at (2,-10) {Hình 7.22};
        \end{tikzpicture}
        \end{center}
...
\begin{practice}
    ...
    \begin{questions}[resume=SBT]
        ...
        \begin{tikzpicture}
            ...
            \node[font=\bfseries] at (0,3.15) {Tỉ lệ vô địch bóng đá nam SEA Games};
            ...
            \node[above] at (0,2.75) {Indonesia 9\%};
            \draw (0,2.35) -- (0,2.6);
        \end{tikzpicture}
        ...
        \begin{center}
        \begin{tikzpicture}[x=1.35cm,y=0.11cm]
            \coordinate (O) at (0,0);
            \draw[->] (O) -- (5.25,0);
            \draw[->] (O) -- (0,42);
            \foreach \y in {0,5,...,40} {
            ...
            \node[rotate=90] at (-0.65,20) {Tỉ lệ};
            \node at (2.5,-10.5) {Thành tích (m)};
