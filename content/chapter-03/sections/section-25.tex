...
\begin{lesson}
    ...
    \begin{center}
        \begin{tblr}{
            colspec={Q[c,m,2.6cm] *{6}{Q[c,m,1.25cm]}},
            rows={1cm}
        }
            \tikz[baseline=(hdr.center)]{
                \node[inner sep=0pt, minimum width=2.05cm, minimum height=.72cm] (hdr) {};
                \draw (hdr.north west)--(hdr.south east);
                \node[anchor=north east, font=\small, inner sep=1pt] at (hdr.north east) {Xúc xắc};
                \node[anchor=south west, font=\small, inner sep=1pt] at (hdr.south west) {Đồng xu};
            } & 1 & 2 & 3 & 4 & 5 & 6 \\
    ...
    \begin{center}
        \begin{tblr}{
            colspec={Q[c,m,2.4cm] *{3}{Q[c,m,1.8cm]}},
            rows={1cm}
        }
            \tikz[baseline=(hdr.center)]{
                \node[inner sep=0pt, minimum width=2.05cm, minimum height=.72cm] (hdr) {};
                \draw (hdr.north west)--(hdr.south east);
                \node[anchor=north east, font=\small, inner sep=1pt] at (hdr.north east) {Lần 2};
                \node[anchor=south west, font=\small, inner sep=1pt] at (hdr.south west) {Lần 1};
            } & 1 & 2 & 3 \\
            1 & $(1,\,1)$ & ... & ... \\
            2 & ... & ... & ... \\
            3 & ... & ... & $(3,\,3)$ \\
    ...
    \begin{center}
        \begin{tblr}{
            colspec={Q[c,m,2.2cm] *{4}{Q[c,m,1.65cm]}},
            rows={1cm}
        }
            \tikz[baseline=(hdr.center)]{
                \node[inner sep=0pt, minimum width=1.85cm, minimum height=.72cm] (hdr) {};
                \draw (hdr.north west)--(hdr.south east);
                \node[anchor=north east, font=\small, inner sep=1pt] at (hdr.north east) {Lần 2};
                \node[anchor=south west, font=\small, inner sep=1pt] at (hdr.south west) {Lần 1};
            } & 1 & 2 & 3 & 4 \\
    ...
    \begin{center}
        \begin{tblr}{
            colspec={Q[c,m,2.4cm] *{4}{Q[c,m,1.55cm]}},
            rows={1cm}
        }
            \tikz[baseline=(hdr.center)]{
                \node[inner sep=0pt, minimum width=2.05cm, minimum height=.72cm] (hdr) {};
                \draw (hdr.north west)--(hdr.south east);
                \node[anchor=north east, font=\small, inner sep=1pt] at (hdr.north east) {Dạng hạt};
                \node[anchor=south west, font=\small, inner sep=1pt] at (hdr.south west) {Màu hạt};
            } & BB & Bb & bB & bb \\
            AA & ... & ... & ... & ... \\
            Aa & ... & ... & ... & ... \\
        \end{tblr}
