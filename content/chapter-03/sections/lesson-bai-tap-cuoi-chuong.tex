...
\begin{exercises}
    ...
    \begin{questions}[resume=SGK]
        ...
        $A$: “Hai số ghi trên hai tấm thẻ chênh nhau 2 đơn vị”;\par
        $B$: “Hai số ghi trên hai tấm thẻ chênh nhau lớn hơn 2 đơn vị”;\par
        $C$: “Tích hai số ghi trên hai tấm thẻ là một số chẵn”;\par
        ...
        $E$: “Tổng số chấm xuất hiện trên hai con xúc xắc bằng 11”;\par
        $F$: “Tổng số chấm xuất hiện trên hai con xúc xắc bằng 8 hoặc 9”;\par
