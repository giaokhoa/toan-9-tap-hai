...
\begin{lesson}
    ...
    \begin{tikzpicture}
        \coordinate (A) at (0,0);
        \coordinate (B) at (4,0);
        \path[name path=AC] (A)--++(40:6);
        \path[name path=BC] (B)--++(120:6);
        \path[name intersections={of=AC and BC, by=C}];
        \path[name path=AI] (A)--++(20:6);
        \path[name path=BI] (B)--++(150:6);
        \path[name intersections={of=AI and BI, by=I}];
        \coordinate (D) at ($(A)!(I)!(B)$);
        \draw (A)--(B)--(C)--cycle;
        \draw (A)--(I) (B)--(I) (C)--(I);
        \draw (I)--(D);
        \draw let \p1=($(I)-(D)$), \n1={veclen(\x1,\y1)} in (I) circle (\n1);
        \fill (I) circle (1.2pt);
        \node[below left=1pt of A] {$A$};
    ...
    \begin{tikzpicture}
        ...
        \coordinate (I) at (0,\rin);
        \coordinate (D) at (0,0);
        \coordinate (X) at ($(B)!1.1cm!(C)$);
        \coordinate (Y) at ($(B)!1.1cm!(A)$);
        \coordinate (Z) at ($(B)!0.62!(I)$);
        \draw (A)--(B)--(C)--cycle;
        \draw (B)--(I) (C)--(I);
        \draw (I)--(D);
        \draw (I) circle (\rin);
        \draw[dashed] let \p1=($(X)-(Z)$), \n1={veclen(\x1,\y1)} in (X) circle (\n1);
        \draw[dashed] let \p1=($(Y)-(Z)$), \n1={veclen(\x1,\y1)} in (Y) circle (\n1);
