...
\begin{lesson}
    ...
    \begin{tikzpicture}
        \begin{scope}[xshift=-4.2cm]
            ...
            \node[right=1pt of Bone] {$B$};
            \node[right=1pt of Oone] {$O$};
            \node at (0,-1.95) {Trường hợp 1};
        \end{scope}
        \begin{scope}
            ...
            \node[right=1pt of Btwo] {$B$};
            \node[right=1pt of Dtwo] {$D$};
            \node[right=1pt of Otwo] {$O$};
            \node at (0,-1.95) {Trường hợp 2};
        \end{scope}
        \begin{scope}[xshift=4.2cm]
            ...
            \node[below=1pt of Bthree] {$B$};
            \node[right=1pt of Dthree] {$D$};
            \node[above=1pt of Othree] {$O$};
            \node at (0,-1.95) {Trường hợp 3};
        \end{scope}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \coordinate (ABnear) at ($(A)!0.24!(B)$);
        \coordinate (ACnear) at ($(A)!0.24!(C)$);
        \coordinate (L60) at ($(ABnear)!0.5!(ACnear)$);
        \node[left=1pt of L60] {$60^\circ$};
    \end{tikzpicture}
...
\begin{exercises}
    ...
    \begin{questions}[series=SGK]
        ...
        \begin{tikzpicture}
            \coordinate (O) at (0,0);
            \coordinate (A) at (160:1.55);
            \coordinate (B) at (40:1.55);
            ...
            \draw (160:0.52) arc[start angle=160,end angle=40,radius=0.52];
            \draw (40:0.38) arc[start angle=40,end angle=-40,radius=0.38];
            \node at (100:0.78) {$120^\circ$};
            \node at (0:0.67) {$80^\circ$};
        \end{tikzpicture}
        ...
        \begin{tikzpicture}
            ...
            \node[right=1pt of O] {$O$};
            \coordinate (DAnear) at ($(D)!0.24!(A)$);
            \coordinate (DBnear) at ($(D)!0.24!(B)$);
            \coordinate (L30) at ($(DAnear)!0.5!(DBnear)$);
            \node at (L30) {$30^\circ$};
            \coordinate (BDnear) at ($(B)!0.24!(D)$);
            \coordinate (BCnear) at ($(B)!0.24!(C)$);
            \coordinate (L50) at ($(BDnear)!0.5!(BCnear)$);
            \node at (L50) {$50^\circ$};
        \end{tikzpicture}
