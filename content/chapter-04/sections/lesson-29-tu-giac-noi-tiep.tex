...
\begin{lesson}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \node[below=4pt of Oa] at (0,-1.55) {a)};
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \coordinate (D) at (50:2);
            \path[name path=ABline] (A)--($(A)!3!(B)$);
            \path[name path=DCline] (D)--($(D)!3!(C)$);
            \path[name intersections={of=ABline and DCline, by=X}];
            \draw (O) circle (2);
            \draw (A)--(B)--(C)--(D)--cycle;
            \draw (B)--(X);
            \draw (C)--(X);
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \coordinate (D) at (0.8,-1.7);
            \coordinate (E) at (0.8,1.7);
            \coordinate (F) at (-0.8,-1.7);
            \draw (A)--(B)--(C)--(D)--cycle;
            \draw (A)--(E)--(C)--(F)--cycle;
            \draw (A)--(C);
            \node[left=1pt of A] {$A$};
