...
\begin{lesson}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \draw (A)--(B)--(C)--cycle;
            \draw (O)--(A) (O)--(B) (O)--(C);
            \pic[draw, "$30^\circ$", angle radius=5mm, angle eccentricity=1.35] {angle=B--A--O};
            \pic[draw, "$40^\circ$", angle radius=5mm, angle eccentricity=1.35] {angle=O--A--C};
    ...
    \begin{questions}[resume=SGK]
        ...
        \begin{center}
            \begin{tikzpicture}[x=1.1cm,y=1.1cm]
                ...
                \path (P)--node[right=5pt] {$900\text{ m}$} (Q);
                \path (P)--node[above=5pt] {$1\,200\text{ m}$} (R);
                \path (Q)--node[sloped,below=5pt] {$1\,500\text{ m}$} (R);
